...
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s', filename='evaluation_bumble.log', filemode='w')
...
def main():
    ...
    profile_count = 0
    image_paths = ["/Users/frederic/tinder-bot/profile_image_bumble.jpg"]  # Liste des chemins d'image à évaluer
